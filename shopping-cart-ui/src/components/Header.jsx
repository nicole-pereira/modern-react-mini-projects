...
const Header = () => {
  ...
  return (
    <header className="bg-white shadow-md p-4 flex justify-between items-center">
      <h1 className="text-2xl font-bold text-orange-600">ShopMate</h1>
          ...
          <div className="absolute right-0 mt-2 w-80 bg-white border-rounded shadow-lg z-50">
            <div className="p-4">
              ...
              {cart.length === 0 ? (
                ...
                <>
                  <ul className="max-h-50 overflow-y-auto divide-y divide-gray-200">
                    {cart.map((item) => (
                      <li
                        key={item.id}
                  ...
                  <button
                    onClick={clearCart}
                    className="mt-3 w-full bg-red-600 text-white py-1 rounded transition cursor-pointer hover:bg-red-600">
                    Clear Cart
                  </button>
                </>
              )}
